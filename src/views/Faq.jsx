...
const Faq = () => {
    return (
        <div className="w-full h-full">
            <Header />
            <BMSpinBanner />
            <div><h1 ><strong><span ><span >Frequently Asked Questions</span></span></strong></h1>
                <h2 ><span >ABOUT THE SERVICE</span></h2>
                <article className="grid grid-cols-2">
                    <FaqComponent title={<h3><span >"ARE THERE ANY HARD DATA LIMITS?"</span></h3>}
                    ...
                    <FaqComponent title={<h3><span >"HOW MUCH DATA DO YOU GET IN YOUR DATA PLAN?"</span></h3>}
                    ...
                    <FaqComponent title={<h3><span >"WHAT NETWORKS DO YOU USE?"</span></h3>}
                        paragraph={<p><span >Blue Magic internet operates off of GSM networks and their participating towers.</span></p>}
                    />

                    <FaqComponent title={<h3><span >"HOW DO I GO ABOUT CHECKING TO SEE IF I CAN GET SERVICE IN MY AREA?"</span></h3>}
                    ...
                    <FaqComponent title={<h3><span >"HOW DO I ACTIVATE MY SERVICE ONCE I RECEIVE MY PRODUCTS?"</span></h3>}
                    ...
                    <FaqComponent title={<h3><span >"HOW DO I MAKE A PAYMENT?"</span></h3>}
                ...
                <article className="grid grid-cols-2">
                    <FaqComponent title={<h3>"TELL ME MORE ABOUT THE BRING YOUR OWN DEVICE PROGRAM?"</h3>}
                    ...
                    />
                    <FaqComponent title={<h3>"WHAT IS THE DIFFERENCE BETWEEN THE NETGEAR NIGHTHAWK AND THE MASTER ROAM?"</h3>}
                ...
                <article className="grid grid-cols-2">
                    <FaqComponent title={<h3>"MY BOX IS BLINKING AN ORANGE LIGHT AND I JUST PAID MY BILL?"</h3>}
                    ...
                    />
                    <FaqComponent title={<h3>"MY BOX IS BLINKING AN ORANGE LIGHT AND I STILL HAVE TWO WEEKS TIL MY PAYMENT IS DUE."</h3>}
                    ...
                    />
                    <FaqComponent title={<h3>"MY BOX KEEPS REBOOTING AND WON'T CONNECT TO ANY OF MY OTHER DEVICES"</h3>}
                    ...
                    />
                    <FaqComponent title={<h3>"WHAT IS <strong>NOT</strong> COVERED BY THE WARRANTY?"</h3>}
                ...
                <article className="grid grid-cols-2">
                    <FaqComponent title={<h3>"HOW LONG DOES IT TAKE FOR THE PRODUCT TO SHIP?"</h3>}
                        paragraph={<p>Our online department is available Monday-Friday and can take up to 1-2 business days to ship the product.</p>}
                    />
                    <FaqComponent title={<h3>"WHAT IS THE RETURN POLICY?"</h3>}
                    ...
                    />
                    <FaqComponent title={<h3>"HOW LONG DOES IT TAKE FOR THE PRODUCT TO BE DELIVERED TO ME?"</h3>}
                    ...
                    />
                    <FaqComponent title={<h3>"HOW WILL I KNOW THIS WILL WORK FOR ME?"</h3>}
